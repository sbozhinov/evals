$(document).ready(function(){
	...
	//when the duplicatebutton is clicked
    ...
    function getCourse(){
    	$.ajax({
  				url: 'duplicate_course/allCourses',
  				type: 'POST',
  				dataType: 'JSON',
    ...
    $('#instructor').change(function(){
    	...
    	if(data == "*")
  		...
  		else
  		{
  			...
  			$.ajax({
	    		url: 'duplicate_course/queryInstructor',
	    		data: data,
	    		type: 'POST',
	    		dataType:'JSON',
	    		success: function(data){
    ...
    $('#courseNumber').change(function(){
    	...
    	if(data == "*")
  		...
  		else
  		{
	    	...
	    	$.ajax({
	    		url: 'duplicate_course/queryCourseNumber',
	    		data: data,
	    		type: 'POST',
	    		dataType:'JSON',
	    		success: function(data){
	...
	$("#subject").change(function(){
		...
		else
		{
			...
			//ajax call to the controller
	    	$.ajax({
	    		url: 'duplicate_course/querySubject',
	    		data: data,
	    		type: 'POST',
	    		dataType:'JSON',
	    		success: function(data){
	...
	$("#year").change(function(){
		...
		if(data == "*")
  		...
  		else
  		{
			...
			//ajax call to the controller
	    	$.ajax({
	    		url: 'duplicate_course/queryYear',
	    		data: data,
	    		type: 'POST',
	    		dataType:'JSON',
	    		success: function(data){
	...
	$("#quarter").change(function(){
		...
		else
		{
			...
			//ajax call to the controller
	    	$.ajax({
	    		url: 'duplicate_course/queryQuarter',
	    		data: data,
	    		type: 'POST',
	    		dataType:'JSON',
	    		success: function(data){
